...
/* Modified by Evan Malone, Cornell University
6/15/2006, to improve behavior with USB virtual COM port drivers */
...
#define NOT_OPEN_NUM -1
#define NOT_OPEN_NAME "Port Not Open"
