...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Amber Needle, Silver-filled silicone
...
PUSHOUT		0.1  				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.1				//[seconds] reverse plunger motion to stop flow quickly 
DEPOSITIONRATE  0.002				//(mm plunger motion per mm of path length)
CLEARANCE	2.0				//[mm] clearance between tip and last layer when traversing
PATHSPEED	7.0				//[mm/s] speed along paths when depositing material
