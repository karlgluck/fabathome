y// This is a tool file for the 2-Syringe Tool, left 10ml syringe with Red Taper tip
...
PUSHOUT		0.26 sec // early dispensing to start flow quickly
SUCKBACK	0.27 sec // reverse plunger motion to stop flow quickly 
RANGE		0 80 0 // [mm] start end home
DEPOSITIONRATE  0.00093 //(mm plunger motion per mm of path length)
BACKFILL	12 mm
