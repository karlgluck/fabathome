// This is a tool file for a 10ml syringe with Olive Taper tip, play doh material
...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Olive(1.54mm) taper tip (EFD 5125TT-B), PlayDoh
TIPDIAM		1.54				//[mm], internal diameter of syringe needle/tip
PATHWIDTH	1.65				//[mm] width of stream of material deposited
PATHHEIGHT	1.3				//[mm] height of layers of material deposited
PUSHOUT		0.75  				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.75				//[seconds] reverse plunger motion to stop flow quickly 
DEPOSITIONRATE  0.012				//(mm plunger motion per mm of path length)
CLEARANCE	2.0				//[mm] clearance between tip and last layer when traversing
PATHSPEED	12				//[mm/s] speed along paths when depositing material
PAUSEPATHS	10				//number of paths after which to trigger an automatic pause
