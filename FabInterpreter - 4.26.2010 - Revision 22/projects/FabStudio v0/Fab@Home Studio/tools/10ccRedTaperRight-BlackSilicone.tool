// This is a tool file for the 2-Syringe Tool, right 10ml syringe with Red Taper tip
; written by Evan Malone, April 11, 2007

DESCRIPTION 	Right 10cc Syringe (EFD 5111LL-B), Red (0.25mm ID) taper tip (EFD 5125TT-B)
PATHWIDTH	0.4 mm
PATHHEIGHT	0.3 mm
...
PLUNGERCOLOR	1 0 0 0.5  // R G B Alpha in range 0-1 (alpha=transparency)
DIRECTION	0 0 -1	//orientation of graphical display of motion of plunger
VOLUME		10 cc
MOTOR		4 -1 0.000396875 //amp axis #, axis direction(+/-1), mm per step
PUSHOUT		0.25 sec // early dispensing to start flow quickly
SUCKBACK	0.25 sec // reverse plunger motion to stop flow quickly 
RANGE		0 80 0 // [mm] start end home
DEPOSITIONRATE  0.0009 //(mm plunger motion per mm of path length)
BACKFILL	12 mm
