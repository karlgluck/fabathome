// This is a tool file for a 10ml syringe, left of two, with Pink tip with sugar support
...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Pink (0.61) taper tip, sugar support
TIPDIAM		0.61				//[mm], internal diameter of syringe needle/tip
PATHWIDTH	0.6				//[mm] width of stream of material deposited
PATHHEIGHT	0.5				//[mm] height of layers of material deposited
PUSHOUT		0.48  				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.45				//[seconds] reverse plunger motion to stop flow quickly 
DEPOSITIONRATE  0.0014				//(mm plunger motion per mm of path length)
