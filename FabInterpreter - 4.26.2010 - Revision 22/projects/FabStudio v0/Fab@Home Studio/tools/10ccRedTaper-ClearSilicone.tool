// This is a tool file for a 10ml syringe with Red Taper tip with clear silicone
...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Red (0.25mm ID) taper tip (EFD 5125TT-B), clear Silicone
...
DEPOSITIONRATE  0.0007				//(mm plunger motion per mm of path length)
