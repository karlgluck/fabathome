// This is a tool file for a 10ml syringe, right of two, with Green tip with frosting
...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Green (0.8382) taper tip (EFD 5125TT-B), frosting
...
PUSHOUT		1.1  				//[seconds] early dispensing to start flow quickly
SUCKBACK	1.1				//[seconds] reverse plunger motion to stop flow quickly 
SUCKBACKDELAY	0.55				//[SECONDS] delay in the onset of suckback
DEPOSITIONRATE  0.0032				//(mm plunger motion per mm of path length)
