// This is a tool file for a 10ml syringe, right of two, with Green tip with jelly
...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Green (0.8382) taper tip (EFD 5125TT-B), jelly
...
PUSHOUT		0.19  				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.172				//[seconds] reverse plunger motion to stop flow quickly 
...
PATHSPEED	14				//[mm/s] speed along paths when depositing material
