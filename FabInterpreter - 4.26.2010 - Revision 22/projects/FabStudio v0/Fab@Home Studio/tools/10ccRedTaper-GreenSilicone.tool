...
PATHWIDTH	0.4				//[mm] width of stream of material deposited
PATHHEIGHT	0.3				//[mm] height of layers of material deposited
PUSHOUT		0.245  				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.23				//[seconds] reverse plunger motion to stop flow quickly 
DEPOSITIONRATE  0.0006				//(mm plunger motion per mm of path length)
