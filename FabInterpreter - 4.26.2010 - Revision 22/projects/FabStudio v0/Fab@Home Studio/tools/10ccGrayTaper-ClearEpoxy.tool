// This is a tool file for a 10ml syringe with Red Taper tip with white silicone
...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Red (0.25mm ID) taper tip (EFD 5125TT-B), white Silicone
TIPDIAM		1.1938				//[mm], internal diameter of syringe needle/tip
PATHWIDTH	1				//[mm] width of stream of material deposited
PATHHEIGHT	0.5				//[mm] height of layers of material deposited
PUSHOUT		0.3  				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.25				//[seconds] reverse plunger motion to stop flow quickly 
DEPOSITIONRATE  0.005				//(mm plunger motion per mm of path length)
CLEARANCE	2.0				//[mm] clearance between tip and last layer when traversing
PATHSPEED	5.0				//[mm/s] speed along paths when depositing material
