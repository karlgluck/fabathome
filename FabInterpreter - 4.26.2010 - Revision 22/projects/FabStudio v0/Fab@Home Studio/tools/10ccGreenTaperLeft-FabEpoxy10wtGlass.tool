// This is a tool file for a 10ml syringe, left of two, with Green tip with FabEpoxy, 10wt% 1/16" milled glass fiber
...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Green (0.8382) taper tip (EFD 5125TT-B), FabEpoxy 10wt Glass
...
PUSHOUT		0.09 				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.08				//[seconds] reverse plunger motion to stop flow quickly 
DEPOSITIONRATE  0.0030				//(mm plunger motion per mm of path length)
CLEARANCE	2				//[mm] clearance between tip and last layer when traversing
PATHSPEED	7				//[mm/s] speed along paths when depositing material
PAUSEPATHS	50				//number of paths after which to trigger an automatic pause
