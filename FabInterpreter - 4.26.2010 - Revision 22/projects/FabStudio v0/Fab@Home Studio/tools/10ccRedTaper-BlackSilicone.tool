// This is a tool file for a 10ml syringe with Red Taper tip with Black silicone
...
DESCRIPTION 	10cc Syringe (EFD 5111LL-B), Red (0.25mm ID) taper tip (EFD 5125TT-B), Black Silicone
TIPDIAM		0.25				//[mm], internal diameter of syringe needle/tip
PATHWIDTH	0.38				//[mm] width of stream of material deposited
PATHHEIGHT	0.28				//[mm] height of layers of material deposited
PUSHOUT		0.22  				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.22				//[seconds] reverse plunger motion to stop flow quickly 
DEPOSITIONRATE  0.00065			//(mm plunger motion per mm of path length)
