// This is a tool file for a 10ml syringe, left of two, with olive tip with PlayDoh
...
PATHWIDTH	1.6				//[mm] width of stream of material deposited
PATHHEIGHT	1.35				//[mm] height of layers of material deposited
PUSHOUT		0.7  				//[seconds] early dispensing to start flow quickly
SUCKBACK	0.6				//[seconds] reverse plunger motion to stop flow quickly 
...
PAUSEPATHS	100				//number of paths after which to trigger an automatic pause
