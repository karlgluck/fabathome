...
PUSHOUT		1.45  				//[seconds] early dispensing to start flow quickly
SUCKBACK	1.45				//[seconds] reverse plunger motion to stop flow quickly 
DEPOSITIONRATE  0.0040				//(mm plunger motion per mm of path length)
CLEARANCE	2				//[mm] clearance between tip and last layer when traversing
PATHSPEED	3				//[mm/s] speed along paths when depositing material
