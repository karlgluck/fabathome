...
string FabAtHomePrinter::loadConfigFile(string filePath)
{
     ...
     for(unsigned int i = 0; i < count; ++i)
     {
          ...
          if(name.compare("Y") == 0 /*|| name.compare("Z") == 0 */) //CHANGE MADE in v0.1 z should now be pos for down neg for up
          {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FabAtHomePrinter::savePreviousConfigName(string name) {

	ofstream myfile;
	myfile.open ("PreviousConfigFilePath.txt");
	myfile << "\\\\Previous File Config Path.\n";

	myfile <<name;
	myfile.close();
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
string FabAtHomePrinter::loadPreviousConfigName() {
  ifstream myfile;
  myfile.open("PreviousConfigFilePath.txt");
  if (myfile.is_open())
  {
