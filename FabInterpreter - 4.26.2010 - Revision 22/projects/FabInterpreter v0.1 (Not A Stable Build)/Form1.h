...
public:
	Form1(map<string, string, LessThanString> commandMap, bool isConfig, bool isFabFile) //A map from the commands to their paramters) 
	{
		InitializeComponent();
		...
		if (isConfig) {
			//load config
			map<string,string,LessThanString>::iterator i = commandMap.find("--config");

			Form1::loadConfigHelper(i->second);
		}

		if (isFabFile) {
			//load path
			map<string,string,LessThanString>::iterator i2 = commandMap.find("--fabfile");

			Form1::LoadFileButton_Helper(i2->second);
		}
...
private: System::Windows::Forms::Button*  LoadPreviousConfig;
...
private:
	...
	void InitializeComponent()
	{
		...
		this->LoadPreviousConfig = (new System::Windows::Forms::Button());
		...
		this->InitButton->Font = (new System::Drawing::Font(S"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
			(System::Byte)0));
		this->InitButton->Location = System::Drawing::Point(229, 1);
		this->InitButton->Name = S"InitButton";
		this->InitButton->Size = System::Drawing::Size(218, 50);
		this->InitButton->TabIndex = 0;
		this->InitButton->Text = S"Load New Config";
		...
		// panel3
		// 
		this->panel3->Controls->Add(this->LoadPreviousConfig);
		...
		// LoadPreviousConfig
		// 
		this->LoadPreviousConfig->Font = (new System::Drawing::Font(S"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
			(System::Byte)0));
		this->LoadPreviousConfig->Location = System::Drawing::Point(0, 3);
		this->LoadPreviousConfig->Name = S"LoadPreviousConfig";
		this->LoadPreviousConfig->Size = System::Drawing::Size(223, 47);
		this->LoadPreviousConfig->TabIndex = 1;
		this->LoadPreviousConfig->Text = S"Load Previous Config";
		this->LoadPreviousConfig->UseVisualStyleBackColor = true;
		this->LoadPreviousConfig->Click += new System::EventHandler(this, &Form1::loadPreviousConfig);
		// 
		// panel4
		// 
		...
		this->openFileDialog1->InitialDirectory = S"C:\\Documents and Settings\\FabAdmin\\Desktop\\SVN- FAB@Home.org\\software\\projects\\pr" 
			S"inters\\fabathome-model2\\Fab@Home Interpreter\\Printers";
		// 
		// Form1
		// 
		this->AutoScaleBaseSize = System::Drawing::Size(5, 13);
		this->ClientSize = System::Drawing::Size(905, 465);
...
private: System::Void loadConfigHelper(string filePath) {
			 ...
			 if(result.compare("") == 0)
			 {
				 ...
				 FabAtHomePrinter::savePreviousConfigName(filePath);
				 ...
				 //Start live position display
				 enablePositionDisplay(); 
			 }
			 else
			 {
...
private: void InitButton_Click(System::Object *  sender, System::EventArgs *  e)
		 {
			 ...
			 {
				 loadConfigHelper((char*)(void*)Marshal::StringToHGlobalAnsi(openFileDialog1->FileName));
			 }
...
private: void ResetPosButton_Click(System::Object*  sender, System::EventArgs*  e) 
		 ...
		 //////////////////////////////////////////////////////////////////////////////////////
private: void LoadFileButton_Helper(string filePath) {
...
private: void LoadFileButton_Click(System::Object *  sender, System::EventArgs *  e)
		 {
			 if(openFileDialog1->ShowDialog() == System::Windows::Forms::DialogResult::OK)
			 {
				 LoadFileButton_Helper((char*)(void*)Marshal::StringToHGlobalAnsi(openFileDialog1->FileName));
...
private: System::Void loadPreviousConfig(System::Object*  sender, System::EventArgs*  e) {

			 string filePath = FabAtHomePrinter::loadPreviousConfigName();
			 string result = printer.initialize(filePath);
			 if(result.compare("") == 0)
			 {
				 correctModule = true;
