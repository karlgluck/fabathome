...
static long (*ServoGetPos)(byte) = reinterpret_cast<long(*)(byte)>(DLL::loadFunction("NMCLIB04.dll","ServoGetPos"));  
static byte (*ServoGetAux)(byte) = reinterpret_cast<byte(*)(byte)>(DLL::loadFunction("NMCLIB04.dll","ServoGetAux"));
static BOOL (*ServoResetPos)(byte) = reinterpret_cast<BOOL(*)(byte)>(DLL::loadFunction("NMCLIB04.dll","ServoResetPos"));
static BOOL (*ServoSetGain)(byte,short,short,short,short,byte,byte,short,byte,byte) = reinterpret_cast<BOOL(*)(byte,short,short,short,short,byte,byte,short,byte,byte)>(DLL::loadFunction("NMCLIB04.dll","ServoSetGain"));
static BOOL (*ServoStopMotor)(byte,byte) = reinterpret_cast<BOOL(*)(byte,byte)>(DLL::loadFunction("NMCLIB04.dll","ServoStopMotor"));
static BOOL (*ServoLoadTraj)(byte,byte,long,long,long,byte) = reinterpret_cast<BOOL(*)(byte,byte,long,long,long,byte)>(DLL::loadFunction("NMCLIB04.dll","ServoLoadTraj"));
